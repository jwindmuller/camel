...
function homepageBuilder(page, completion, redirect) {
    var indexInfo = CUtils.generateHtmlAndMetadataForFile(global.postsRoot + 'index.md');
    var footnoteIndex = 0;
    ...
    Posts.paginated(function (pages) {
        ...
        var fileData = CUtils.generateHtmlAndMetadataForFile(global.postsRoot + 'index.md');
